...
PROMPT = "Generate a meme prompt and text for an edgy meme, along with a caption and around 10 hashtags for the post. A meme prompt is used to generate the meme base image with DALL·E 2, and the text part is intended to be overlayed on the image, completing the meme. Use the format: 'Meme Prompt: [prompt] | Text: [text] | Caption: [caption] | Hashtags: [hashtags]'."
